    ...
    <div class="box">
        ...
        <div class="box-body">
            <form id="form" class="form-inline">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-success" onclick="m_search();">
            ...
            <table id="table" class="table table-striped" data-url="page" data-search-from="form"
                   data-remove-callback="remove" data-checkbox="true" data-add-callback="add">
                <thead>
                <tr>
